package com.kushal.user.service.UserService.config;
...
import com.kushal.user.service.UserService.config.interceptors.RestTemplateInterceptor;
...
//	Bean deceleration of OAuth2AuthoriedClient manager
	@Bean
